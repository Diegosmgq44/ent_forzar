       ...
       if (data.info.info !== undefined) {
        ...
        if(!/^[A-Za-z0-9]/.test(data.info.info)) {
           ...
           if (data.info.info2 !== undefined) {
                ...
                <div id="code">' + 'ENTORNO' + '</div>\
                <div id="alert-name">' + 'PERSONA ANÓNIMA' + '</div>\
                ...
                <div id=""><span style="text-verflow: hidden; white-space: nowrap;"><i class="fas fa-keyboard"></i>' + 'Pulsa [Y] para mostrar en GPS' + '</span></div>\
                </div>');
                $notification.height = '140px'
            } else {
                $notification.html('\
                <div class="content">\
                <div id="marker"><i class="fas fa-map-marker-alt" aria-hidden="true"></i></div>\
            ...
            <div id=""><span style="text-verflow: hidden; white-space: nowrap;"><i class="fas fa-globe-europe"></i>' + 'Pulsa [Y] para mostrar en GPS' + '</span></div>\
            </div>');
